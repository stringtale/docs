...
Next.js we support both the App router and the (legacy) Pages router. If you use the (legacy) Pages router, please check the [Pages router documentation](/backend/next-js-pages-router) instead.
