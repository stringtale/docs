...
Next.js we support both the App router and the (legacy) Pages router. If you use the App router, please check the [App router documentation](/backend/next-js-app-router) instead.
