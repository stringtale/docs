...
Learnhow to get notified of text updates in your Slack channel using the Slack webhook.
...
2. Once create, you should have a Webhook URL looking something like this: `https://hooks.slack.com/services/T00000000/B00000000/XXXXXXXXXXXXXXXXXXXXXXXX`. You're going to add this to your Stringtale project.
