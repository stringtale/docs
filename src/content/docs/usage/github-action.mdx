...
4. Add the Token you obtained from the dashboard as `STRINGTALE_TOKEN` to the required environment(s) or create a new one.
  ...
  build-web:
    ...
    - name: Run stringtale action
      ...
      env:
        ...
        # STRINGTALE_TOKEN is the token that the CI uses to access the Stringtale API
