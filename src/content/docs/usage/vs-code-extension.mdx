...
![Selected text in VS Code](../../../assets/images/vscode-extension/step-2.png)

3. Hit `Ctrl/Cmd + Shift + P` and exexcute `String tale: Wrap`

![VS Code Command Palette with Stringtale: Wrap selected](../../../assets/images/vscode-extension/step-3.png)
...
![Stringtale offering to rename the name attribute for the Value tag](../../../assets/images/vscode-extension/step-4.png)

5. Once you've accepted the name, the VS Code wrap your text in a `<Value>` tag, rendering the field editable in your browser.

![Stringtale has wrapped the static text with a Value tag](../../../assets/images/vscode-extension/step-5.png)
