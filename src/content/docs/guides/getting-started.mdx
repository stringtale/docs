...
Deploying Stringtale to your test environment is easy. Just deploy your application as usual, add `STRINGTALE_API_KEY` to your
environment variables and you're good to go. You can start using Stringtale by adding `?stringtale` to the URL or use our browser extension.

{/* Steps to obtain the variable */}

For more information on how to use Stringtale once you've deplyed it, checkout the [workflow](/guides/workflow) documentation.
