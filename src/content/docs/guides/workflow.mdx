...
5. Once you've finished making changes, click on `Save changes` to save them to Stringtale, ready for the developer to integrate with the next update.
   <Aside type="tip">
     It's highly recommended you lock down your test / preview environment
     through some form authentication (i.e. basic auth), as there's no user
     authentication for text edits in Stringtale at this moment.
   </Aside>
